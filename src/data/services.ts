...
export const services: Service[] = [
  ...
  },
  {
    slug: "flat-roofs",
    name: "Flat Roofs",
    shortDesc: "Single-ply membrane flat roofing — Fatra, Armourplan, Danosa and EPDM. Long-lasting, fully guaranteed systems.",
    longDesc: `Flat roofs get a bad reputation, but a properly installed modern single-ply membrane can last 25–35 years with minimal maintenance. S.C Roofing installs a range of single-ply flat roofing systems to suit different budgets, roof configurations and exposure conditions. We do not install GRP fibreglass.\n\n**EPDM Rubber** — a single-ply membrane bonded to the deck. Extremely durable, lightweight and ideal for extensions and garage roofs. 20-year guarantee available.\n\n**Fatra** — a high-performance PVC-P single-ply membrane manufactured in the Czech Republic. Mechanically fixed or fully adhered, with excellent dimensional stability and a 25-year guarantee on system installations.\n\n**Armourplan** — a PVC single-ply membrane from IKO. Fleece-backed for direct adhesion to insulation or deck. Well suited to refurbishment overlays and complex detailing.\n\n**Danosa** — a Spanish-manufactured single-ply system with strong European track record on commercial and domestic applications.\n\n**Torch-on Felt** — traditional SBS modified bitumen system. Cost-effective for larger flat areas. All systems include a full build-up to current U-value requirements.`,
    metaTitle: "Flat Roofs Bath & Somerset | Fatra, Armourplan, Danosa & EPDM | SC Roofing",
    metaDescription: "Flat roof specialists in Bath & Somerset. Single-ply membrane systems — Fatra, Armourplan, Danosa and EPDM. Extensions, garages, commercial. Free survey. 07881 903 188.",
    icon: "📐",
